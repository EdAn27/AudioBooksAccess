...
window.escuchar = function () {
  ...
  hablar("Escoge un curso: comunicación, matemática, historia, ciencia o inglés", () => {
...
reconocimiento.onresult = function(event) {
  ...
  else if (texto.includes("comunicación") || texto.includes("comunicacion")) {

  hablar("Abriendo curso de comunicación", () => {

    localStorage.setItem("busquedaVoz", "comunicacion");
